		...
		new_venue.save
		offer = Offer.new(offer_id: 'asdfasdf',influence_1: '0.2', influence_2: '0.3',influence_3: '0.6',fb_post:'Acabo de hacer checkin con ThanxUp, los mejores descuentos!' ,offer_text: 'Los mejores tacos de regalo a partir de 10% de influencia')
		new_venue.offers.push(offer)
		new_venue.save
