		...
		new_venue.save
		offer = Offer.new(offer_id: 'Fruta',influence_1: '0.1', influence_2: '0.5',influence_3: '0.7',fb_post:'Una excelente healthy food' ,offer_text: 'Ensalada gratis con 10% de influencia. Con mas de 0.5 te llevas postre también')
